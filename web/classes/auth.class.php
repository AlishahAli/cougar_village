...
class Auth
{
  ...
  //prevent creating a new object of the class with new Auth()
...
*/
  public function logout()
  {
    ...
    if (isset($_COOKIE['remember_token'])) {
      ...
      //delete record from the database, note the hash
      ...
      //the expiration time is an hour, which will make the browser delete the cookie
   ...
   *pass boolean $remember_me// remove this because a flag isn't available in the db
   *pass return boolean              true if the new user record was saved successfully, false otherwise
   */
